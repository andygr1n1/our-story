        ...
        <APIProvider apiKey={apiKey}>
            ...
            >
                <div className='text-lg  mt-20 mx-auto font-kzen'>
                    <div className='flex px-4 flex-col gap-2 max-w-[500px] mx-auto'>
                        <div className='caveat-500 text-3xl my-2'>- 12.00 - {t('marriageCeremony')}</div>
                        <div>{t('marriageCeremonyAddress')}</div>
                    </div>
                    <div className='min-h-[300px] my-10 min-w-[400px] bg-red-500 relative h-[500px] shadow-[0_0_24px_0_rgba(34,33,51,0.15)]'>
                        <Map
                            defaultZoom={18}
